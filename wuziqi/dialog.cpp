...
SelectDialog::SelectDialog(QWidget * parent,Qt::WindowFlags f) :QDialog(parent)
{
 ...
 QHBoxLayout *layout2 =new QHBoxLayout;
  ...
  label3 = new QLabel(tr("对战的算法为："),this);
    ...
    connect(currentTimesSlider,SIGNAL(valueChanged(int)),
      			this,SLOT(currentTimesChanged(int)));
...
void SelectDialog::getValue(int & bAlgo, int & wAlgo, int &
		currentTimes)
{
 bAlgo = bAlgorithm;
 wAlgo = wAlgorithm;
